...
<head>
	<title>Tony Tours - Best Attraction | Ambalangoda Traditional  Mask Museum</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-ahungalla-cooking5" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Ambalangoda Traditional  Mask Museum</h3>
					<h4>An Extraordinarily Colourful Craft of Mask-Making</h4><br>
                    <p class="day-tour_para">Devil masks are a hallmark of our island’s history. These intricate, colourful, and eerie masks are deeply rooted in Sri Lankan folklore and have been interwoven into our culture over the years, especially on the south coast.</p>
