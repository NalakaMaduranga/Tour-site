...
<head>
	<title>Tony Tours - Best Attraction | Romantic Dinner by the Sea</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-ahungalla-cooking3" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
					...
					<h4>Best romantic moment under the star</h4><br>
                    <p class="day-tour_para">
					For romance like out of a picture book,you should book a candlelight dinner for two directly on the beach in a special setting.Its unique,intimate atmosphere,deliouse food and beautiful location give a magic for our your romantic dinner.
					</p>
             
                    
                    <h3>Perfect for nice walk an  unforgetable dinner with your loved one. </h3>
                    <p class="day-tour_para">Celebrate the sunset with your feet in the sand and panoramic views of the glittering waters of bentota or hikkaduwa bay, while a refreshing sea breeze plays around the palm trees to the gentle sound of waves.Sparkling wine and a dinner of your choice( Sea food platter..etc) complete this special evening.</p>
                </div>
                	...
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                                ...
                                <li>We will pick up at at 5 p.m from your hotel. </li>
                                <li>You will have your romantic dinner in hikkaduwa or bentota beach.</li>
