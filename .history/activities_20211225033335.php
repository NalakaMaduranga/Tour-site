...
<head>
	<title>Tony Tours - Activities</title>
	...
	<meta name="keywords" content="Tony Tours, Tony Travels,Ahungalla Tours,Ahungalla,Tony Sri Lanka Tours,Tailor Made Tours,Sri Lanka Tour, Sri Lanka,Tony Sri Lanka Tours,Best Activity in Sri Lanka,Water Sport,Activities,Sea Turtle,Shopping, Wood Cravings,Spice Garden" />
		...
		<div class="container">
            ...
            <div class="row">
            	<div class="col-sm-12" style="margin-bottom:40px;">
                	<div class="col-sm-8">
                        <h3 style="margin-bottom:10px;">Water Sport</h3>
                        <p>Water sports such as water skiing, jet skiing, snorkeling and diving, windsurfing, banana and tube riding are available and can be booked through your local tour operator. Water sports are highly popular in areas such as Bentota, Kalpitiya, and even Bolgoda Lake!</p>
                    </div>
                    
                    <div class="col-sm-4">
                    	<img src="images/activities/water-sport.jpg">
                    </div>
                </div>
                ...
                <div class="col-sm-12" style="margin-bottom:40px;">
                	<div class="col-sm-4">
                    	<img src="images/activities/sea-Turtle.jpg">
                    </div>
                    
                	<div class="col-sm-8">
                        <h3 style="margin-bottom:10px;">Sea Turtle</h3>
                        <p>Besides seeing the sea turtles in the ocean, this is the second best place to see them. You can tell they
was really well looked after which was great. The guides were very knowledgeable and their knowledge in different languages was amazing. You can tell everyone working here has a real passion for the sea turtles.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-12" style="margin-bottom:40px;">
                    <div class="col-sm-8">
                        <h3 style="margin-bottom:10px;">Shopping</h3>
                        <p>Sri Lanka has been a very famous trading hot spot in the world history. Bustling markets, designer boutiques, modern shopping malls and gloriously kitsch souvenir stalls – whatever your holiday shopping style, Sri Lanka has it covered.</p>
                    </div>
                        
                    <div class="col-sm-4">
                        <img src="images/activities/shoping.jpg">
                    </div>
                </div>
            
           		<div class="col-sm-12" style="margin-bottom:40px;">
                	<div class="col-sm-4">
                    	<img src="images/activities/spice_guarden.jpg">
                    </div>
                    
                	<div class="col-sm-8">
                        <h3 style="margin-bottom:10px;">Spice Garden</h3>
                        <p>Enjoy the Sri Lanka’s world renowned spices at their source. Visit a spice garden, where smells of
cinnamons, pepper, cardamom, nutmeg and mace overwhelm the senses and the visitors are provided an insight into an age old industry of spice production, which attracted many a European and Asian merchants to the ports of ancient Sri Lanka.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-12" style="margin-bottom:40px;">
                    <div class="col-sm-8">
                        <h3 style="margin-bottom:10px;">Wood Cravings</h3>
                        <p>A wood craftman also was in that crew and that was the beginning of the implementation of wood carving in Sri Lanka. Lankathilaka Temple and Ambekke Devalaya in Kandy are the best places we can prove the history and traditional skills.</p>
                    </div>
                        
                    <div class="col-sm-4">
                        <img src="images/activities/wood-carving.jpg">
                    </div>
                </div>
