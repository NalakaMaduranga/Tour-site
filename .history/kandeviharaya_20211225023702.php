...
<head>
	<title>Tony Tours - Best Attraction | Ahungalla Cooking Class</title>
	...
	<meta name="keywords" content="Safari, yala, yala National Park, Elephant, Leopard" />
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-ahungalla-cooking" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Sri Lankan Cooking Class</h3>
					<h4>Best Sri Lankan home cooking experience</h4><br>
                    <p class="day-tour_para">Rather than get to know Sri Lankan cuisine via restaurant menus, discover the essence of local food with this private market and home-cooking experience in Ahungalla. Buy ingredients at local food markets with your friendly hosts, and visit their Induruwa very calm home to cook traditional authentic Sri Lankan RICE AND CURRIES.</p>
                    
                    <p class="day-tour_para">Our cooking class is a place where people can come and feel like it is their second home. We cook a range of healthy traditional Sri Lankan dishes, using fresh and natural ingredients. Guests can get an experience of real Sri Lankan hospitality and choose from a range of dishes, including fish, meat, vegetarian.</p>
                    
                    <h3>ART OF CURRY FOR THE FOODIE IN YOU</h3>
                    <p class="day-tour_para">Cooking with us will not only give you the knowledge to recreate the classic Sri Lankan dishes, but is also an experience of real, traditional Sri Lankan hospitality with all its warmth and fun.The class will take you through the spices used in Sri Lankan food and general preparation techniques. We will cook with you a delicious meal which you can then enjoy at leisure afterwards.You will take home a good appreciation of the basics of cooking Sri Lankan food as well as the ability to prepare a few dishes to an excellent standard.</p>
                </div>
                
                <div class="col-sm-5">
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                        	<p class="tip-title">Key Points</p>
                            <ul>
                            	<li>Free pick up & drop-off to anywhere (Your Hotel) in Ahungalla,Kosgoda,Induruwa,Bentota & Balapitiya areas.</li>
                                <li>One day’s notice to arrange a session. </li>
                                <li>Maximum per session is limited to 4 heads. </li>
                                <li>We will give a free trip to Cookery class , Market and pick your own choice of vegetables and fish. </li>
                                <li>The class will share the cooked meal free of charge at the end of each session. A fantastic programmed giving you the opportunity to learn to cook the wonderful, unique, varied and extremely healthy cuisine of Sri Lanka.</li>
