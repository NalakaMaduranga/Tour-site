...
<body>
	...
	<div class="blog" id="blog">
		<div class="container">
			...
			<p class="para-agileits">We offer a range of Ahungalla day tours to show you the hidden treasures of the area in the most authentic way promising you an unforgettable holiday experience. Find the best day tours and excursions from RIU Ahungalla and Heritance Ahungalla hotels with Tony Sri Lanka. </p>
			<h5></h5>
    ...
    <div class="container-1">
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <p class="handpickerTxt">We have selected a few from our wide range of themed tour itineraries that we believe will offer you an unforgettable holiday in Sri Lanka. For those who have different holiday preferences in Sri Lanka, we cater to tailor-made itineraries as per your requests. So do not hesitate to let us know if you need a special itinerary made just for you.</p>
