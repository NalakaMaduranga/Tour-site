                ...
                <div class="col-sm-5">
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                        	<p class="tip-title">We Makes</p>
                            <ul>
                            	<li>Rice (Red or White).</li>
                                <li>05 Vegetable Curry.</li>
                                <li>Fish or Chicken Curry.</li>
                                <li>Coconut Sambol.</li>
                                <li>Papadam.</li>
                                <li>Traditional Desert.</li>
                            </ul>
                        </div>
                                                
                        <div class="tip-box-inner trip-price key-point">
                        	<p class="tip-title">Class Times</p>
                            <ul>
                            	<li>Lunch class at 10.30am to 2.00pm.</li>
                                <li>Dinner class at 4.30pm to 8.00pm.</li>
                            </ul>
                        </div>
                    </div>
                </div>
