...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 banner_bottom_left" style="background-color:#337AB7; padding-bottom:100px">
				<br>
			<h3>Why Choose us?</h3>
				</h3>
				<br>
				<p class="para-agileits">
				•	A wide selection of high-quality tours
...
•	Premium touring experience with ultimate comfort
				...
				<div class="col-md-6 banner_bottom_rightnew">
