...
•	Premium touring experience with ultimate comfort
  ...
  <div class="card-body">
   ...
   <img src="images/sport.png">
    ...
    <div class="home-cover" id="overlays">
    	<div class="container-1">
...
<br>&nbsp; </p>
    ...
    <div class="section section-09" style=" margin-top: 100px;">
    	<div class="container-fluid">
        	<div class="row">
                	...
                	<div class="row">
                    	<div class="col-md-6">
                        	<div class="inner-cont">
                                ...
                                <p>Located in the beautiful Indian Ocean, Sri Lanka is an island located next to India, that offers you a diversity of experiences that will take your breath away at every corner. From turquoise beaches, emerald green rain forests, lush tea plantations, cascading waterfalls, a vibrant culture, luxury hotels to heart-racing water sports and much more, Sri Lanka has everything you need to spend an unforgettable tropical island holiday escape.</p>
        ...
        <div class="container-1">
        	<div class="row">
                <div class="col-sm-1 col-xs-12 quction talk-us">
                	<h5>Whtsapp Us</h5>
                    <p>+94 771873421</p>
                    <p>To Discuss with a local expert</p>
                </div>
                ...
                <a href="tailor-made-tour.php"><div class="col-sm-1 col-xs-12 quction tailor-make">
                    ...
                    <!--<p>+94 771873421</p>-->
                    <p>To Customize Your tour packages</p>
                </div></a>
        	</div>	
        </div>
    </div>
