    ...
    <div class="home-cover">
    	<div class="container-1">
            <div class="row review" id="owl-demo4">
                <div class="col-sm-1 comment customer-review">
                	<div class="test-review item">
						...
						<div class="textagile">
							...
							<p>We booked to stay at the RIU hotel in Ahungalla and were looking to organise tours before we arrived in Sri Lanka so we could plan the rest of the holiday around them. Tony’s tours were the highest rated tours for that area so I contacted Tony for more information
...
.</p>
                ...
                <div class="col-sm-1 comment customer-review">
                	<div class="test-review item">
						...
						<br>
							<h4>Fabulous tours by father and son!</h4><br>
                            <p> I contacted Tony from the UK and he was very responsive and gave us lots of information which was fantastic.
I can not recommend this company enough. By far the best thing I have done in my life and thankyou Tony's tours for the trip of a lifetime. 
<br>&nbsp; </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-1 comment customer-review">
                	<div class="test-review item">
						...
						<br>
                            ...
                            <p> My husband and I arrived in Ahungulla to stay at the Riu and contacted Tony to set up 2 days of tours, one in Kandy and the other in Galle. It is well worth the money and an experience that you won't forget!!</p>
                        </div>
                    </div>
                </div>
