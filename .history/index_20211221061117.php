...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 banner_bottom_left" style="background-color:#337AB7; padding-bottom:50px">
				<br>
			<h3>Why Choose us?</h3>
				</h3>
				<br>
...
•	Premium touring experience with ultimate comfort
				...
				<div class="col-md-6 banner_bottom_rightnew" styLE="padding-bottom:10px">
