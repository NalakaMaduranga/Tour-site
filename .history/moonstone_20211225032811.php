		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Moonstone Mining In Meetiyagoda</h3>
					<h4>Admire Sri Lanka’s Renowned Moonstones</h4><br>
                    <p class="day-tour_para">Wedged between Ambalangoda and Hikkaduwa, the small village of Meetiyagoda has gained a reputation for its moonstone mines. Unlike other moonstones, Sri Lankan moonstones are extremely rare, displaying a milky-white colour tinged with a shade of blue. Walk through one of these moonstone mines to see how these beautiful stones are excavated.</p>
                    
              
                    
                    <h3>A TREASURE TROVE BENEATH THE SURFACE</h3>
                    <p class="day-tour_para">There’s no better place to see how moonstones are mined, excavated, and sorted than at Meetiyagoda, Sri Lanka’s largest moonstone mine. As the mine is just 8.5km from Ambalangoda, we suggest you pair this experience with a visit to the famed Ariyapala Mask Museum or go surfing in Hikkaduwa.Should you desire, we can create a full-day itinerary to ensure you experience the very best the south coast has to offer.</p>
                </div>
                	...
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                                ...
                                <li>
								Legend has it that Meetiyagoda was once blessed by the moon, which is why the land is abundant with moonstones.
								</li>

								<li>
								You can walk down one of the mines, but it can get quite muddy, so you will be most comfortable if you wear tennis shoes.
</li>

<li>
At the end of the tour, you can purchase some moonstones to take back home as souvenirs for your loved ones or as a keepsake for yourself.
</li>
