		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Tour Overview</h3>
					<h5>Discover the Exotic Mangroves of Balapitiya</h5>
					<br>
                    ...
                    <h3>ENRICH YOUR BEACH GETAWAY</h3>
                    <p class="day-tour_para">The Madu Ganga is in proximity to the coast, making it an exciting and easy excursion from your beach resort. This expansive river is peppered with islets, and on the larger islands, cinnamon is grown.On your safari, you can visit one of these islands to learn about the intricate process of how this fragrant spice is grown. Should you have any questions about this experience, our team will be eager to assist you.</p>
                </div>
                	...
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                                ...
                                <li>In order to fully appreciate the beauty of Madu Ganga, the boat safari will take between two to three hours.</li>
                                <li>Some local families living along the river have introduced ‘fish therapy’ where you can dip your feet into one of these makeshift tanks within the river and have a unique ‘spa’ experience.</li>
                            <li>Wear your hat, sunglasses, and apply sunblock, and mosquito repellent.</li>
