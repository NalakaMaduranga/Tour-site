...
<head>
	<title>Tony Tours - Best Attraction | Bentota Water Sport</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-ahungalla-cooking2" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Water Sports In Bentota</h3>
					<h4>Cruise Along the Bentota River</h4><br>
                    <p class="day-tour_para">
					A short drive away from Riu hotel in Ahungalla is the popular town of Bentota, often referred to as the country’s water sports capital. With the river on one side and the beach on the other, enjoy the best of both worlds here. Wakeboard across emerald waters or enjoy a slow boat ride through the dense mangroves of Bentota.
					</p>
                    <p class="day-tour_para">
Beyond the statue, the temple also houses a Stupa, Relic Chamber and a 300-year old Bodhi tree.
.</p>
                    
                    <h3>WATER SPORTS IN BENTOTA - THERE’S SOMETHING FOR EVERYONE</h3>
                    <p class="day-tour_para">Whether you’re travelling as a couple or as a group with kids, water sports in Bentota will delight all travellers. From gliding along the water on a jet ski or getting an adrenaline rush on a banana boat, you will be spoilt for choice.Talk to us if you need any help arranging your day of fun and sun, or if you need some water sports recommendations!</p>
                </div>
                ...
                <div class="col-sm-5">
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                            	<li>Free pick up & drop-off to anywhere (Your Hotel) in Ahungalla,Kosgoda,Induruwa & Balapitiya areas.</li>
                                <li>The season for water sports in Bentota runs from November - April. This is when the weather is at its best and the water at its calmest. </li>
                                <li>While water sports can be enjoyed by those of all ages, it is recommended kids below the age of 12 do not participate. If you’re travelling with young children, we suggest you visit a turtle hatchery in Kosgoda instead. </li>
                                <li>Apart from adventurous water sports along the Bentota River, you can also explore some of the nearby diving and snorkelling sites.</li>
                               <li>Since you will be spending a day in the sun, be sure you pack sunglasses and sunscreen.</li>
                            </ul>
                        </div>
