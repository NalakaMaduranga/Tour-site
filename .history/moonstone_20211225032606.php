...
<head>
	<title>Tony Tours - Best Attraction | Moonstone Mining In Meetiyagoda</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-ahungalla-cooking6" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Kande Viharaya Temple, Aluthgama</h3>
					<h4>Visit this Ancient Buddhist Temple</h4><br>
                    <p class="day-tour_para">The Kande Viharaya is an ancient Buddhist temple that is located in Aluthgama. Perched on a hillock, the temple, which dates back to the 18th century, has gained recognition for its enormous statue of the Buddha (48 meters tall) that gracefully watches over the town.</p>
                    
                    <p class="day-tour_para">
Beyond the statue, the temple also houses a Stupa, Relic Chamber and a 300-year old Bodhi tree.
.</p>
                    
                    <h3>LEARN THE HISTORY & RELISH THE TRANQUILLITY</h3>
                    <p class="day-tour_para">The temple is one of the most popular tourist attractions in Sri Lanka. It features frescos from the Kandyan era as well as various paintings of the Jataka Tales, allegorical stories of the Buddha’s past life. Spend an afternoon wandering the temple grounds, and if you’d like, we  will guide you with everthing so that you don’t miss any exciting parts of the temple’s history and other interesting facets</p>
                </div>
                	...
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                                ...
                                <li>There are seven sites to see within the temple. Enjoy a slow walk to truly admire these sites, that would usually last for roughly two hours. </li>
                                <li>As this is a place of worship, please dress appropriately. Avoid any clothing that reveals your shoulders and knees </li>
                                <li>Along with visiting the Kande Viharaya, you can pair this tour with a visit to the Bentota local market, or drop by a turtle hatchery in Kosgoda on your way back to your hotel.</li>
                               <li>Minimum number of participants: 2 people / Max. 8 people.</li>
                            </ul>
                        </div>
