...
<head>
	<title>Tony Tours - Best Attraction | Turtle Conservation Project</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-turtle" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Tour Overview</h3>
                    <h5>A Centre for Nature and Conservation</h5>
                    
                    <p class="day-tour_para">The warm golden shores of Sri Lanka have invited many travellers, but sea turtles are perhaps the most loved of these visitors. Five species of endangered sea turtles travel far and wide to nest on  our honey-huedshores.</p>
                    
                    <p class="day-tour_para text-bottom">Turtles frequent towns like Kosgoda, and even Ahungalla, as they’re quieter and not as busy as their neighbouring cities. After all, who doesn’t love a pristine beach?</p>
                    
                    <h3>WHY YOU SHOULD VISIT  KOSGODA TURTLE HATCHERY</h3>
                    <p class="day-tour_para">This is an experience that is fun, meaningful, and awe-inspiring. These sea turtles swim thousands of miles during their lifetime, and when they’re ready to reproduce, they come back to the same beach where they were born to lay their eggs.</p>
					<p class="day-tour_para">Their journey is truly remarkable, but sadly due to an increase in human activity, their population is dwindling. These hatcheries help balance the scales, thus giving the turtles a fighting chance.</p>
				</div>
                	...
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                                ...
                                <li>Kosgoda is the only place in Sri Lanka where all five species of sea turtles come to nest throughout the year</li>
                                <li>The sea turtles you can spot here are the green turtle, olive ridley, hawksbill, loggerhead and leatherback.</li>
                            <li>
							...
							<li>
							Minimum number of participants: 2 people / Max. 8 people.	
							</li>
