...
<head>
	<title>Tony Tours - Best Attraction | Snorkeling In Hikkaduwa</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-hikkaduwa" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Tour Overview</h3>
                    <p class="day-tour_para">Snorkeling in Hikkaduwa is One of the best Activity to do for the tourists who are in Ahungalla and Kosgoda areas minimum of 2 guests are required to proceed the tour.</p>
                    
                    <p class="day-tour_para">If you are keen on doing some snorkeling while exploring the Indian ocean and witness some very uncommon colour fish and corals, then Snorkeling in Hikkaduwa is the best activity for the travellers who are in Ahungalla and surroundings.</p>
                    
                    <p class="day-tour_para text-bottom">Snorkeling in Hikkaduwa package is included free pick up and drop off to any places  Ahungalla and Kosgoda areas.</p>
                    
                    <h3>Snorkeling In Hikkaduwa</h3>
                    <p class="day-tour_para">Snorkeling is the practice of swimming on or through a body of water while equipped with a diving mask, a shaped breathing tube called a snorkel, and usually swimfins. In cooler waters, a wetsuit may also be worn.</p>
                    
                    <p class="day-tour_para">Sri Lanka is surrounded by the Indian Ocean, and its seas are abundant with shallow reefs with corals and marine life. Snorkeling is a safe and easy way to explore the shallower areas around the Island, without the use of diving equipment or extensive training. All one needs are pair of fins, a snorkel, and a face mask. It is a fun sport for all ages as one can view the spectacular underwater world at a leisurely pace. Bentota is one of the best location for snorkeling.</p>
                </div>
                ...
                <div class="col-sm-5">
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                            	<li>Leave for Diving at 8.00am every day.</li>
                                <li>Snorkeling in Hikkaduwa is only available from 1st November to 31st April.</li>
                                <li>Professional Snorkeling masters will guide & care you throughout the activity.</li>
                                <li>Free Pick up & drop-off to anywhere in Ahungalla and kosgoda areas .</li>
                            </ul>
                        </div>
