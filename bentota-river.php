...
<head>
	<title>Tony Tours - Best Attraction | Bentota River</title>
...
<body>
	<!--Header-->
	<div class="header inn-banner inn-banner-bentota" id="home">
		<!--top-bar-w3-agile-->
		...
		<div class="container">
            <div class="row">
            	<div class="col-sm-7 activity">
                	<h3>Tour Overview</h3>
                    <p class="day-tour_para">Bentota River Boat Safari is organized by Tony Sri Lanka Tours for the tourists who are in Ahungalla and Kosgoda area.</p>
                    
                    <p class="day-tour_para">If you are looking to gain a unique experience of lagoon safari witnessing mangroves and some rare animals including crocodiles, then Bentota River Safari is the best activity for the travellers who are in Ahungalla and surroundings.</p>
                    
                    <p class="day-tour_para text-bottom">Bentota River Safari package is included free pick up and drop off to any places in Ahungalla and Kosgoda.</p>
                    
                    <h3>Bentota River</h3>
                    <p class="day-tour_para">River Bentota, the legendary river in southern part of the country, flows into the Indian Ocean forming a lagoon at the last section of the river. The River Bentota and the lagoon set up the widest array of water sports among all the beach resorts of Sri Lanka. Jet-skiing, windsurfing, parasailing or enjoying a romantic river safari along the clam waters are some of the activities that are well known in the area. It has an amazing bio-diversity with all to be experienced within walking distance. Bentota River Boat Safari is more popular and well known for the tourists for witnessing crocodiles in their wild habitat as well as witnessing the amazing aquatic species, fauna & flora of the Bentota River.</p>
                </div>
                ...
                <div class="col-sm-5">
                	<div class="tip-box-main">
                    	<div class="tip-box-inner trip-length key-point">
                            ...
                            <ul>
                            	<li>Tour can be started anytime before 4pm at your convenient time from the Bentota Bridge.</li>
                                <li>Free Pick up & drop-off to anywhere in Ahungalla and kosgoda area.</li>
                                <li>Duration of the River Safari is 2 hours.</li>
                            </ul>
                        </div>
